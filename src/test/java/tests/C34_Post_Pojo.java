...
public class C34_Post_Pojo {
    ...
    public void test01() {
        ...
        PojoHavaDurumu expectedResponseBody = new PojoHavaDurumu(coordPojo,
                                                                 weatherList,
                                                                 "stations",
                                                                 mainPojo,
                                                                 10000,
        ...
        //3-request body gonder ve response'i kaydet
...
response.prettyPrint();
        ...
        Assert.assertEquals(expectedResponseBody.getCoord().getLon(),responseJP.get("coord.lon"));
