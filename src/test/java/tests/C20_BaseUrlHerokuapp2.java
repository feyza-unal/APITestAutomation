...
public class C20_BaseUrlHerokuapp2 extends BaseUrlHerokuapp {
    ...
    public void test01() {
        ...
        JSONObject rezervasyonTarihlerJson = new JSONObject();

        rezervasyonTarihlerJson.put("checkin","2021-06-01");
        rezervasyonTarihlerJson.put("checkout","2021-06-10");
        requestBody.put("firstname", "Ahmet");
        requestBody.put("lastname" , "Bulut");
        requestBody.put("totalprice" ,500);
        requestBody.put("depositpaid" , false);
        requestBody.put("bookingdates",rezervasyonTarihlerJson);
